...
public class EntityDetailActivity extends AppCompatActivity {
    ...
    private static int TOTAL_HOUSE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TOTAL_HOUSE = extras.getInt("TOTAL_ENTITY_NUMBER");
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            TextView textView = (TextView) rootView.findViewById(R.id.txt_entity_attribute_one);
            String message = getString(R.string.section_format);
            int tabId = getArguments().getInt(ARG_SECTION_NUMBER);
            textView.setText(message + String.valueOf(tabId));
            return rootView;
        }
    }
